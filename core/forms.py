...
class CollegeForm(forms.ModelForm):
    ...
    class Meta:
        model = College
        fields = ['name','api_key','desc','logo','root_url','aditional_urls','hints','banner']
        widgets = {
            ...
            'banner': forms.FileInput(attrs={'class': 'form-control', 'style': 'margin-bottom: 10px; padding: 5px;',"required":""}),
        }